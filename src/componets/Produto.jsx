...
export function Produto(){
    return(
        ...
        <div className="bg-[var(--color-chatcolor)] dark:bg-[var(--color-dark-purple-home)]">
            <Header />
            <div className="items-center justify-items-center flex flex-col gap-4 mt-5 mb-5 [color:var(--color-dark-purple)]">
            ...
            <section className="flex flex-col lg:grid lg:grid-cols-2 lg:pl-[10%] lg:pr-[10%]">
